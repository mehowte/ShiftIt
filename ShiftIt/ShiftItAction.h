 ...
 */
typedef NSRect (*ShiftItFunctionRef)(NSRect screenSize, NSRect windowRect, NSRect screens[], int screenCount); 
...
- (id) initWithIdentifier:(NSString *)identifier 
                    ...
                    uiTag:(NSInteger)uiTag 
                   action:(ShiftItFunctionRef)action;
